...
class _HomeViewState extends State<HomeView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: !isPopupActive && homeViewModel.hasHabits
          ? CreateHabitButton()
          : SizedBox.shrink(),
...
class _HomeViewBodyState extends State<_HomeViewBody> {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        FutureBuilder<void>(
          future: homeViewModel.getHasHabits(),
          builder: (context, snap) {
            if (snap.connectionState != ConnectionState.waiting &&
                !homeViewModel.hasHabits) {
              return const _EmptyHomeState();
            }

            return _HomeDashboard(homeViewModel: homeViewModel);
          },
        ),
...
class _HomeDashboard extends StatelessWidget {
  const _HomeDashboard({required this.homeViewModel});
                          ...
                          child: userMessage != null
                              ...
                              : Column(
                                  ...
                                  children: homeViewModel.habits.map((
                                    ...
                                    return HabitItem(
                                      key: ValueKey(habitWithDate.habit.name),
...
class _EmptyHomeState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Padding(
        padding: EdgeInsets.symmetric(horizontal: Spacings.spacious),
        child: Column(
          ...
          children: [
            ...
            Text(
              "Ready for your first habit?",
              textAlign: TextAlign.center,
            ).heading(),
            SizedBox(height: Spacings.comfortable),
            Text(
              "The secret to a better life is hidden in your daily routine. "
